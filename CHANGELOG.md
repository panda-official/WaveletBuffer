...
* DRIFT-605: Add clang-format check to CI, [PR-48](https://github.com/panda-official/WaveletBuffer/pull/48)
...
* DRIFT-605: Fix `.clang-format` include categories order, reformat cpp files, [PR-48](https://github.com/panda-official/WaveletBuffer/pull/48)
